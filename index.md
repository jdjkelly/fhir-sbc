...
| Draft as of 2026-02-16 | *Computable Name*:SBCFHIRImplementationGuide |
...
1. Diagnostic test (x-ray, blood work)
1. Imaging (CT/PET scans, MRIs)
...
1. Facility fee (e.g., ambulatory surgery center)
...
1. Facility fee (e.g., hospital room)
1. Physician/surgeon fees
...
1. Office visits
1. Childbirth/delivery professional services
1. Childbirth/delivery facility services
...
1. Children's eye exam
1. Children's glasses
1. Children's dental check-up
