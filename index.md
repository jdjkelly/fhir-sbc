# Home - Summary of Benefits and Coverage (SBC) FHIR Implementation Guide v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://flexpa.com/fhir/sbc/ImplementationGuide/sbc-fhir-ig | *Version*:0.1.0 |
| Draft as of 2025-11-10 | *Computable Name*:SBCFHIRImplementationGuide |
...
1. Specialist visits
1. Diagnostic tests
1. Imaging (CT/PET/MRI)
1. Generic drugs
1. Preferred brand drugs
1. Non-preferred brand drugs
1. Specialty drugs
1. Facility fees
...
1. Mental/behavioral health outpatient services
1. Mental/behavioral health inpatient services
1. Pregnancy services
1. Childbirth/delivery
1. Pregnancy home health care
...
1. Children's glasses
1. Children's dental check-ups
...
* Review the [SBC to FHIR Mapping](mapping.md) to understand how SBC elements map to FHIR
* Explore the [SBC InsurancePlan Profile](StructureDefinition-sbc-insurance-plan.md)
* Examine the [Example SBC](InsurancePlan-SBCExampleHMO.md) for a complete implementation
* Browse the [Terminology](terminology.md) for benefit category codes
...
```json
{
  ...
  "id" : "sbc-fhir-ig",
  "url" : "http://flexpa.com/fhir/sbc/ImplementationGuide/sbc-fhir-ig",
  "version" : "0.1.0",
  "name" : "SBCFHIRImplementationGuide",
  "title" : "Summary of Benefits and Coverage (SBC) FHIR Implementation Guide",
  "status" : "draft",
  ...
  "description" : "FHIR Implementation Guide for representing Summary of Benefits and Coverage (SBC) documents using the InsurancePlan resource",
  "jurisdiction" : [
    {
      "coding" : [
        {
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://flexpa.com/fhir/sbc/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/benefit-limitation"
        },
        "name" : "Benefit Limitation Extension",
      ...
      },
      {
        ...
        "name" : "Example Health Insurance Issuer",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "InsurancePlan/SBCExampleHMO"
        },
        "name" : "Example SBC - Sample HMO Health Plan",
        ...
        "exampleCanonical" : "http://flexpa.com/fhir/sbc/StructureDefinition/sbc-insurance-plan"
      },
      {
        "extension" : [
          {
        ...
        "reference" : {
          "reference" : "StructureDefinition/excluded-services"
        },
        "name" : "Excluded Services Extension",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/sbc-benefit-category"
        },
        "name" : "SBC Benefit Category Code System",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/sbc-benefit-category"
        },
        "name" : "SBC Benefit Category Value Set",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/sbc-insurance-plan"
        },
        "name" : "SBC Insurance Plan Profile",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "StructureDefinition/sbc-metadata"
        },
        "name" : "SBC Metadata Extension",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "CodeSystem/sbc-plan-type"
        },
        "name" : "SBC Plan Type Code System",
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "ValueSet/sbc-plan-type"
        },
        "name" : "SBC Plan Type Value Set",
