...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'serviceType']) &gt;= 1">extension with URL = 'serviceType': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'serviceType']) &lt;= 1">extension with URL = 'serviceType': maximum cardinality of 'extension' is 1</sch:assert>
