# Profiles - Summary of Benefits and Coverage (SBC) FHIR Implementation Guide v0.1.0
...
**Profile:** [SBCInsurancePlan](StructureDefinition-sbc-insurance-plan.md)
...
1. Each benefit has costs for both in-network and out-of-network (even if "not covered")
1. Contact information includes at minimum phone and web URL
1. Cost values use consistent currency (USD recommended)
1. Percentage-based coinsurance uses "%" unit
1. Fixed copayments use currency code (e.g., "USD")
