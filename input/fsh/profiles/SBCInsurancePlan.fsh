...
* coverage.type from SBCBenefitCategory (extensible)
...
* coverage.benefit.type from SBCBenefitCategory (required)
...
* plan.type 0..1 MS
* plan.type from SBCPlanType (extensible)
...
* plan.specificCost.category from SBCBenefitCategory (required)
...
* plan.specificCost.benefit.type from SBCBenefitCategory (required)
