# SBC Plan Type Value Set - Summary of Benefits and Coverage (SBC) FHIR Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SBC Plan Type Value Set**

## ValueSet: SBC Plan Type Value Set 

| | |
| :--- | :--- |
| *Official URL*:http://flexpa.com/fhir/sbc/ValueSet/sbc-plan-type | *Version*:0.1.0 |
| Draft as of 2026-02-16 | *Computable Name*:SBCPlanTypeVS |

 
Value set containing health insurance plan types for Summary of Benefits and Coverage documents 
